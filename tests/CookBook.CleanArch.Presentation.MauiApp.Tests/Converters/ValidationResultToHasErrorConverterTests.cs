...
public class ValidationResultToHasErrorConverterTests
{
    private readonly ValidationResultToHasErrorConverter _converter = new();

    [Fact]
    public void Convert_ValidResult_ReturnsFalse()
    {
        // Arrange
    ...
    [Fact]
    public void Convert_InvalidResultWithMatchingError_ReturnsTrue()
    {
        // Arrange
    ...
    [Fact]
    public void Convert_InvalidResultWithoutMatchingError_ReturnsFalse()
    {
        // Arrange
    ...
    [Fact]
    public void Convert_InvalidResultWithNullParameter_ReturnsTrue()
    {
        // Arrange
