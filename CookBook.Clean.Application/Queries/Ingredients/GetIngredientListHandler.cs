...
public class GetIngredientListHandler (IRepository<IngredientEntity> repository, IIngredientMapper mapper) : IRequestHandler<GetIngredientListQuery, UseCaseResult<List<IngredientListModel>>>
{
