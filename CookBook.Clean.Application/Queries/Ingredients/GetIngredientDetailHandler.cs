...
internal class GetIngredientDetailHandler(IRepository<IngredientEntity> repository, IIngredientMapper mapper) : IRequestHandler<GetIngredientDetailQuery, UseCaseResult<IngredientDetailModel>>
{
