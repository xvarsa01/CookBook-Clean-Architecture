...
public class IngredientRootTests
{
    ...
    {
        // Act
        var ingredient = IngredientBase.Create("milk", "oak milk", ImageUrl.CreateObject("https://en.wikipedia.org/wiki/Milk#/media/File:Glass_of_Milk_(33657535532).jpg").Value).Value;
    ...
    {
        // Act
        var ingredient = IngredientBase.Create("milk", null, null).Value;
    ...
    {
        var result = IngredientBase.Create(string.Empty, null, null);
