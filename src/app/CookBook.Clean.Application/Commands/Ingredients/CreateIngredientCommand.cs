...
internal sealed class CreateIngredientCommandHandler(IRepository<Ingredient> repository, IIngredientMapper mapper) : ICommandHandler<CreateIngredientCommand, Guid>
{
