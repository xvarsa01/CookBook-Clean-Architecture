...
internal class GetIngredientDetailQueryHandler(IRepository<Ingredient> repository, IIngredientMapper mapper) : IQueryHandler<GetIngredientDetailQuery, IngredientDetailModel>
{
