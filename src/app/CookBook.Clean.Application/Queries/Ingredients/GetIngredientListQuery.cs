...
internal class GetIngredientListQueryHandler (IRepository<IngredientEntity> repository, IIngredientMapper mapper) : IQueryHandler<GetIngredientListQuery, List<IngredientListModel>>
{
